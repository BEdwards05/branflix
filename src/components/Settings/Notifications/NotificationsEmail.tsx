...
const messages = defineMessages('components.Settings.Notifications', {
  ...
  usePublicLogo: 'Use public BranFlix logo instead of instance logo',
  usePublicLogoTip:
    'If your BranFlix instance is not publicly accessible, enable this option so email clients outside your network can display the image. The image will be pulled from the public GitHub repository.',
